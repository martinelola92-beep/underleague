...
| [BI-H](./BI-H.md) | El balón no parece jugado con los pies: la interacción va pegada al aro lógico | **ABIERTA, encargo del revisor en cola** (24 sep 2026): capa de presentación en `/Game` basada en pies/animación, sin tocar `/Sim` (RT-014). Va **después** o a la vez que BI-D: con posesiones de 0,33 s casi no hay conducción que lucir |
