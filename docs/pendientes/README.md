...
| [BI-D](./BI-D.md) | Nadie conduce el balón: tiene dueño el 32,3 % del partido y 0,33 s de media | **ABIERTA, no es de render** (23 sep 2026): 387 de 1.200 ticks con dueño, 77 posesiones, la más larga de cualquiera 0,93 s. Pregunta de diseño para el revisor; alargarla toca `/Sim` y mueve `possessionChanges` y `passChainAvgLength` |
...
| [BI-H](./BI-H.md) | El balón no parece jugado con los pies: la interacción va pegada al aro lógico | **ABIERTA, encargo del revisor en cola** (24 sep 2026; alcance ampliado el 25 sep): capa de presentación en `/Game` anclada al **hueso que corresponde al tipo de contacto** —pies, cuerpo, cabeza, manos—, para **todo** contacto con el balón, sin tocar `/Sim` (RT-014). Va **después** o a la vez que BI-D: con posesiones de 0,33 s casi no hay conducción que lucir |
