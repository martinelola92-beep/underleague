...
| [BF-C](./BF-C.md) | El delantero pega sin balón porque sus alternativas fuera de posesión son peores que pegar (`Tackle` 211 contra `MarkOpponent` 180): es lo único que impide abrirle la entrada | Abierta, medida |
