...
| [BI-H](./BI-H.md) | El balón no parece jugado con los pies: la interacción va pegada al aro lógico | **EN CURSO, primera pasada hecha** (25 sep 2026): el balón se ancla al **hueso** con el que se juega (pie más cercano, cabeza, manos del portero) leído del esqueleto ya animado, y los gestos de contacto salen de los **eventos**, que hasta ahora no llegaban a la vista 3D. Medido: `Header 2 · Receive 36 · Save 1` por partido, separación al pie 0,1 casillas. **Bloqueado para los saques**: `MatchPhase` sólo tiene `Restart` genérico |
