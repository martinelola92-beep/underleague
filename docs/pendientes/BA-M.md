...
congelando el catálogo de perks en cinco commits y viendo el número moverse 1,7 puntos solo, con un valor
verdadero estimado en ~2,4). El "+2,0 justo" que este fichero medía queda a solo ~0,4 errores típicos de
ese valor verdadero — indistinguible de ruido de muestreo, no evidencia de una diferencia real respecto a
cualquier otro punto de la serie. **La acusación a `a0a8b33` no se sostiene**: no hay evidencia de que ese
commit moviera la métrica; el movimiento observado es del tamaño que este instrumento produce por azar en
cualquier commit, se toquen perks o no.
