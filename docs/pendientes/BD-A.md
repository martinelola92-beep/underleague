# BD-A — Las faltas de área se reparten 3 a 1 entre la mitad de abajo y la de arriba

Estado: **abierta**. Encontrada el 20 sep 2026 por el `independent-reviewer` dentro de la medición de la
...
- **CONFIRMED**: el desequilibrio existe en la muestra medida (300 partidos, una semilla).
- **Sin comprobar**: que se reproduzca con otras semillas. Una sola semilla no distingue sesgo de ruido; es
  el primer experimento a hacer, y es barato.
