...
**La correa vuelve al presupuesto** tras la ADR 0028. La propuesta inicial era dejarla fuera, porque con un radio circular duro era el atributo de mayor valor marginal con diferencia (+6,7 puntos de tasa de victoria por cada +10 en orcos, frente a +0,5 de la fuerza) y cualquier reparto óptimo la habría maximizado. Al pasar a una **zona con forma dada por la posición**, el atributo solo escala el tamaño de una región ya acotada —no permite que un defensa juegue de delantero— y su valor debería quedar en la escala de los demás. Se remide tras el rediseño espacial antes de darlo por bueno.
